...
Which crate(s) would this change? e.g. `scenix-material`, `scenix-renderer`, `scenix-post`

## Additional Context

Links to prior art (Three.js, Bevy, wgpu examples), related issues, or research papers.
