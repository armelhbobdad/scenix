...
This page explains the supported ways to depend on Scenix v1.0.0. Use the facade crate for application code and focused crates when you are building a library or a very small tool.
